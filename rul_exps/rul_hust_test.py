...
from tensorflow.keras.layers import (
    ...
    RNN, SimpleRNNCell, MultiHeadAttention, GlobalAveragePooling1D, Flatten, Attention, Activation
)
        ...
        for cell_type in model_types:
            ...
            if fold_scores["score"]:
                ...
                if all_preds:
                    ...
                    plt.plot(moving_average(mean_preds,window_size=20), label=r"Predicted", color='blue')
